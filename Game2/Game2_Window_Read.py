...
##                            raw_hdc,0,0,WHITENESS))#CAPTUREBLT))   
        ...
        flag=True
        temp0=[]
        temp0.append(windll.gdi32.GetPixel(self.vwin.hdc,int(main_top[0][0]*4+offsetx),int(main_top[0][1]*4+offsety)))
        temp0.append(windll.gdi32.GetPixel(self.vwin.hdc,int(main_top[1][0]*4+offsetx),int(main_top[1][1]*4+offsety)))
        temp0.append(windll.gdi32.GetPixel(self.vwin.hdc,int(main_top[2][0]*4+offsetx),int(main_top[2][1]*4+offsety)))
        for i in range(3):
            print(temp0)
##            time.sleep(.01)
...
##            print(main_top[i][0],main_top[i][1])
            temp=windll.gdi32.GetPixel(self.vwin.hdc,int(main_top[i][0]*4+offsetx),int(main_top[i][1]*4+offsety))
##            print(temp)
...
##            y=main_bottom[i][1]*4+offsety
            if main_bottom[i][2]!=windll.gdi32.GetPixel(self.vwin.hdc,main_bottom[i][0]*4+offsetx,main_bottom[i][1]*4+offsety):
                flag=False
                break
##            
        if flag==True:
