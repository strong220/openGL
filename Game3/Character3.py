...
from Character3_draw_down import Draw_DOWN
from Character3_draw_up import Draw_UP
from Character3_draw_right import Draw_RIGHT
from Character3_draw_left import Draw_LEFT
print("loading character1 libraries...")

class Character3_Sprite(Character_Sprite_Main):
    def __init__(self,hdc_main,file_path_main,hwnd,name):
        ...
        ##BRING IN IMAGES##
        print("loading character3 images...")
