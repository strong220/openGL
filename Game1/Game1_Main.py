...
from Game1_window_update import *
...
def main():
    ...
    hWnd = windll.user32.CreateWindowExA(0,wclassName,wname,WS_OVERLAPPEDWINDOW | WS_CAPTION,CW_USEDEFAULT, CW_USEDEFAULT,1227,800,0,0,hInst,0)  #Create Window
    if not hWnd:
        print(GetLastError())
